  ...
  <div className="search">
    ...
    <div className="header">
      <form onSubmit={submitHandler}>
        <input id="postTitleInput" type="text" placeholder="Post Title" required minLength={2} maxLength={20} ref={postTitleInputRef} />
        <br />
        ...
        <button id="post" type="submit">Post Now</button>
        <br />
        <br />
        <span>
          {alert && alert}
